...
integer1 = Number(artists[0].years.split("-",1));
integer2 = Number(artists[0].years.split(integer1, 1));
...
//     if(split array[i].years("the integer") >= "1900" && split array[i].years("the second integer") <= 2000){ //or it might use the `${}` function
